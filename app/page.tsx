    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <nav className="border-b border-white/10 px-8 py-4 flex items-center justify-between sticky top-0 bg-[#0a0a0a]/80 backdrop-blur-sm z-50">
        ...
        <div className="hidden md:flex items-center gap-2 text-sm absolute left-1/2 -translate-x-1/2">
          <a href="#" className="text-white/70 hover:text-white border border-white/10 hover:border-violet-500/40 hover:bg-violet-500/10 transition-all px-3 py-1.5 rounded-lg font-medium">Inicio</a>
          <a href="#como-funciona" className="text-white/70 hover:text-white border border-white/10 hover:border-violet-500/40 hover:bg-violet-500/10 transition-all px-3 py-1.5 rounded-lg font-medium">Cómo funciona</a>
          <a href="#features" className="text-white/70 hover:text-white border border-white/10 hover:border-violet-500/40 hover:bg-violet-500/10 transition-all px-3 py-1.5 rounded-lg font-medium">Features</a>
          <a href="#precios" className="text-white/70 hover:text-white border border-white/10 hover:border-violet-500/40 hover:bg-violet-500/10 transition-all px-3 py-1.5 rounded-lg font-medium">Precios</a>
        </div>
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 gap-8 py-24 relative">
        ...
        {/* CTAs hero — solo para no logados */}
        {!session && (
        ...
        {/* Si está logado, solo botón demo */}
        {session && (
      ...
      <section id="precios" className="scroll-mt-20 px-6 py-24 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-6 p-8 rounded-2xl border border-violet-500/50 bg-violet-500/10 shadow-[0_0_40px_rgba(139,92,246,0.1)] relative">
            ...
            <ul className="flex flex-col gap-3">
              {["Chatbots ilimitados", "Conversaciones ilimitadas", "Base de conocimiento con IA", "Soporte prioritario"].map(f => (
                <li key={f} className="flex items-center gap-2 text-sm text-white/70">
                  <Check className="w-4 h-4 text-violet-400 shrink-0" />{f}
                </li>
              ))}
      ...
      {/* CTA final — solo para usuarios no logados */}
      {!session && (
